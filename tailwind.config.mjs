      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-bullets': theme('colors.text-secondary-light'),
            ...
            '--tw-prose-code': theme('colors.text-light'),
        ...
        invert: {
          css: {
            ...
            '--tw-prose-bullets': theme('colors.text-secondary-dark'),
            '--tw-prose-hr': theme('colors.border-dark'),
            '--tw-prose-quotes': theme('colors.text-dark'),
            '--tw-prose-quote-borders': theme('colors.accent-primary'),
